...
from .views import api_root, RegisterView, LoginView, ResetpasswordView, LogoutView, BookView, DeleteView, UpdateView, BorrowView, ReserveView, RenewBorrowView, ReturnBookView, CancelReservationView, HistoryView, FineView, PaymentProcessView, PaymentVerifyView
...
urlpatterns = [
    ...
    path('payments/initiate/', PaymentProcessView.as_view(), name='payment'),
    path('payments/verify/<str:reference>/', PaymentVerifyView.as_view(), name='verify-payment'),
