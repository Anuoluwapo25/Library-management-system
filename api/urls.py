...
from .views import api_root, RegisterView, LoginView, ResetpasswordView, LogoutView, BookView, DeleteView, UpdateView, BorrowView, ReserveView, RenewBorrowView, ReturnBookView, CancelReservationView, HistoryView, FineView, PaymentProcessView
